// ==UserScript==
// @name         Uer/U校园/UTALK/网课答案显示/自动填写/支持测试/时长挂机/unipus
// @namespace    Oranged
// @version      2.2.7
// @description  [√自动填入答案【默认延迟2秒】][√窗口显答案][√作业与测试][√视听说单元测试][√时长挂机][√UTALK]（支持班级测试、单元测试，自动翻页挂时长，积分用于统计使用频率）【禁止对源码进行修改，发布，禁止抄袭任意代码】
// @author       Oranged
// @compatible   Chrome
